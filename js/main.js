...
var resizePizzas = function(size) {
  ...
  function sizeSwitcher (size) {
    var w = document.querySelector("#randomPizzas").offsetWidth;
    switch(size) {
      case "1":
        return 0.25 * w;
      case "2":
  ...
  var nSize = Math.ceil(sizeSwitcher(size));
  var containers = document.querySelectorAll(".randomPizzaContainer");

    for (var i = 0; i < containers.length; i++) {
      containers[i].style.width = nSize + "px";
    }
  }
